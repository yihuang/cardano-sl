...
module Pos.Network.Communication.Relay.Class
       ( Relay (..)
       , InvReqDataParams (..)
       , DataParams (..)
       , MempoolParams (..)
...
import           Pos.Network.Communication.Types.Protocol (EnqueueMsg, Msg,
                     NodeId)
import           Pos.Network.Communication.Types.Relay (DataMsg, InvMsg,
                     InvOrData, MempoolMsg, ReqMsg, ReqOrRes)
import           Pos.Network.Topology.Types (Origin)

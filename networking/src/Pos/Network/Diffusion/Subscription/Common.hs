...
module Pos.Network.Diffusion.Subscription.Common
...
import qualified Pos.Network.Diffusion.Subscription.Status as Status
                     (subscribed, subscribing, terminated)
import           Pos.Network.Topology.Types (Bucket (..), NodeType)

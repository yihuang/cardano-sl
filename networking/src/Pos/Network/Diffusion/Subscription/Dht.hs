...
module Pos.Network.Diffusion.Subscription.Dht
...
import           Pos.Network.Communication.Protocol (NodeId, SendActions)
import           Pos.Network.Topology.Types (Bucket (..), NodeType, choosePeers)

...
module Pos.Network.Diffusion.Subscription.Dns
...
import           Pos.Network.Communication.Protocol (SendActions)
import           Pos.Network.Diffusion.Subscription.Common
                     (SubscriptionMessageConstraints, networkSubscribeTo')
import           Pos.Network.Diffusion.Subscription.Status (SubscriptionStates)
import           Pos.Network.Diffusion.Subscription.Subscriber (SubscribeTo,
                     SubscriptionTarget (..), subscriber)
import           Pos.Network.Topology.DnsDomains (NodeAddr)
import           Pos.Network.Topology.Types (Bucket (..), DnsDomains (..),

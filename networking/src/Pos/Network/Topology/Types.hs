...
module Pos.Network.Topology.Types
...
import           Pos.Network.Topology.DnsDomains (DnsDomains (..), NodeAddr)
import qualified Pos.Network.Topology.DnsDomains as DnsDomains
import qualified Pos.Network.Topology.Policy as Policy

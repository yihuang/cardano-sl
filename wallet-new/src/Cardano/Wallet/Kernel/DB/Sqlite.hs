...
| tx_meta_id | tx_meta_amount | tx_meta_created_at | tx_meta_is_local | tx_meta_is_outgoing | tx_meta_account | tx_meta_account
|------------+----------------+--------------------+------------------+---------------------|-----------------|-----------------
| Core.TxId  | Core.Coin      | Core.Timestamp     | Bool             | Bool                | Word32          | Core.Address
